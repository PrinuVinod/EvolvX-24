      ...
      <section id="about" className={classes.aboutSec}>
        <div className={classes.about}>
          <div className={classes.details}>
            ...
            <p className={classes.para}>EvolvX '24 is a highly anticipated technical fest organized by the Computer Science and Engineering Association of Amal Jyothi College of Engineering. This event is specially curated for technology enthusiasts, students, and professionals to come together and showcase their innovative ideas, technical skills, and creativity. This year, EvolvX '24 is scheduled to take place on the 22nd of April 2024, and promises to be an exciting and engaging event. The fest will feature a plethora of competitions covering a wide range of topics related to computer science and engineering.
            </p>
          </div>
